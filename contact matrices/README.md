...
Each cell of the contact matrices $M_{ij}$ represents the weighted mean number of contacts with individuals in age group j reported by a participant in age group i. 
